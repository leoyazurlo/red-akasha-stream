...
import {
  ...
  Volume2, VolumeX, Heart, ListMusic, Music, Mic2,
} from "lucide-react";
...
export const AudioBottomPlayer = () => {
  ...
  return (
    <>
      {/* Lyrics Panel */}
      <AudioLyricsPanel open={lyricsOpen} onClose={() => setLyricsOpen(false)} />
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-card border-t border-border h-20 flex items-center px-4 gap-4">
        ...
        <div className="flex items-center gap-3 w-72 flex-shrink-0">
          <div className="w-14 h-14 rounded-md overflow-hidden bg-muted/30 flex-shrink-0 relative">
            ...
            {isPlaying && (
              <div className="absolute bottom-0.5 right-0.5">
                <AudioEqualizer isPlaying={true} size="sm" barCount={3} />
              </div>
            )}
          </div>
