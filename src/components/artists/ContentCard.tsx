...
export const ContentCard = ({ content, categoryLabel, index }: ContentCardProps) => {
  ...
  return (
    <Card 
      className="group overflow-hidden cursor-pointer transition-all duration-300 hover:shadow-elegant hover:scale-[1.02] animate-fade-in bg-card/80 backdrop-blur-sm border-border/50"
