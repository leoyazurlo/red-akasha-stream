...
export const VideoPlayer = () => {
  return (
    <section className="container mx-auto px-4 py-12 mt-16" id="home">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Video Player */}
        <div className="relative aspect-video bg-card rounded-2xl overflow-hidden shadow-glow border border-border group">
